...
def show_history_modal():
     ...
     if hist_df.empty:
         ...
         edited_hist = st.data_editor(
             df_view,
             column_order=("ID", "Fecha_Reporte", "Poza", "Turno", "Norte", "Este", "Cota_Teorica", "Cota_Real_Terreno", "Desv_Real", "Observacion", "Estado"),
             column_config={
